...
public final class ActivityPickPlaceBinding implements ViewBinding {
  ...
  private ActivityPickPlaceBinding(@NonNull LinearLayout rootView, @NonNull ListView listPlaces,
  ...
  public static ActivityPickPlaceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPickPlaceBinding((LinearLayout) rootView, listPlaces, toolbar);
    }
